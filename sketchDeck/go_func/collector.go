...
func MakeCollection(pathImages string) ([]ImagesWithThumbnails, error) {
	...
	validPaths, err := validateSavePaths(pathImages)
	// err = createImageThumbs(validPaths)
	// err = createImageFullAvi(validPaths)
...
func validateSavePaths(pathImages string) ([][2]string, error) {
